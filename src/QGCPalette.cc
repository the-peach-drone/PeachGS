...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#FA828F", "#3a3a3a", "#fff291")
    ...
    DECLARE_QGC_COLOR(mapIndicator,         "#585858", "#41B6E6", "#585858", "#41B6E6")
    ...
    DECLARE_QGC_NONTHEMED_COLOR(brandThePeachBlue,  "#41B6E6", "#41B6E6")
    DECLARE_QGC_NONTHEMED_COLOR(brandThePeachPeach, "#FA828F", "#FA828F")
    ...
    DECLARE_QGC_SINGLE_COLOR(mapMissionTrajectory,          "#41B6E6")
    DECLARE_QGC_SINGLE_COLOR(surveyPolygonInterior,         "#FA828F")
